...
export default function AnalyticsPage() {
  ...
  if (!data) {
    return (
      <div className="text-center py-12 text-gray-500 font-mono text-sm border border-[#1a1f2e] bg-[#0d1117]/30 rounded-lg">
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        {/* Card 1 */}
        <div className="border border-[#1a1f2e] bg-[#0d1117]/30 p-5 rounded-lg flex flex-col justify-between space-y-2">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-6">
        ...
        <div className="lg:col-span-3 border border-[#1a1f2e] bg-[#0d1117]/20 p-5 rounded-lg space-y-4">
        ...
        <div className="lg:col-span-2 border border-[#1a1f2e] bg-[#0d1117]/20 p-5 rounded-lg space-y-4">
          <h2 className="text-xs font-bold tracking-widest font-mono text-[#6366f1] uppercase">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="border border-[#1a1f2e] bg-[#0d1117]/20 p-5 rounded-lg space-y-4">
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-left border-collapse text-xs font-mono">
              <thead>
                <tr className="border-b border-[#1a1f2e] text-gray-400 uppercase">
              ...
              <tbody className="divide-y divide-[#1a1f2e] text-gray-300">
                {rulePerformance.length === 0 ? (
                  ...
                  rulePerformance.map((rule, idx) => (
                    <tr key={rule.rule_id || idx} className="hover:bg-[#1a1f2e]/10">
              ...
              <tbody className="divide-y divide-[#1a1f2e] text-gray-300">
                {repPerformance.length === 0 ? (
                  ...
                  repPerformance.map((repItem, idx) => (
                    <tr key={repItem.rep || idx} className="hover:bg-[#1a1f2e]/10">
            ...
            <tbody className="divide-y divide-[#1a1f2e] text-gray-300">
              {recentEvents.length === 0 ? (
                ...
                recentEvents.map((evt) => (
                  <tr key={evt.id} className="hover:bg-[#1a1f2e]/10">
                    <td className="py-2.5 font-bold">{evt.prospect_name}</td>
                    <td className="py-2.5">
                      <span className="px-2 py-0.5 bg-[#1a1f2e] text-gray-300 border border-[#1a1f2e] rounded uppercase text-[10px]">
                        {evt.event_type}
                      </span>
                    </td>
